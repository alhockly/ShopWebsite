...
-- **IMPORTANT**
-- Change ah17451 to your username on the next 3 lines before running this script!
DROP DATABASE IF EXISTS ah17451;
CREATE DATABASE ah17451;
USE ah17451;
...
-- **IMPORTANT**
-- Change TWO instances of ah17451 to your username on the next line before
-- running this script!
GRANT DELETE,SELECT,INSERT,UPDATE ON ah17451.* TO 'ah17451'@'localhost' IDENTIFIED BY 'obscure';
